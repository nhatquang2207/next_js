...
const check_register = 'select * from login where users = $1'
const register = 'insert into login (users,email,pass) values ($1,$2,$3) '

module.exports = { select, select_id, create_info, update_info, delete_info, register, login, check_register }